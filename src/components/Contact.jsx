...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M6.25 3C4.46403 3 3 4.46403 3 6.25V17.75C3 19.536 4.46403 21 6.25 21H17.75C19.536 21 21 19.536 21 17.75V6.25C21 4.46403 19.536 3 17.75 3H6.25ZM6.25 4.5H17.75C18.725 4.5 19.5 5.27497 19.5 6.25V17.75C19.5 18.725 18.725 19.5 17.75 19.5H6.25C5.27497 19.5 4.5 18.725 4.5 17.75V6.25C4.5 5.27497 5.27497 4.5 6.25 4.5ZM13.5 12H12V17.5H10V12H8.5V10.5H10V9.5C10 8.12 10.62 7 12.2 7H14V8.5H13C12.67 8.5 12.5 8.67 12.5 9.02V10.5H14.5L13.5 12Z"
          fill="currentColor"
        />
      </svg>
    ),
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[15ch] reveal-up">Contact me for Collaboration</h2>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                {icon}
              </a>
            ))}
          </div>
        ...
        <div>
          <form action="https://getform.io/f/agddoldb" className="xl:pl-10 2xl:pl-20" method="POST">
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              <div className="mb-4">
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  placeholder="Zohaib Masoud"
                  type="text"
                  className="text-feild reveal-up"
                />
              </div>
            ...
            <div className="mb-4">
              ...
              <textarea
                name="massage"
                id="message"
                placeholder="Hello! Am ..."
                required
                className="text-feild resize-y min-h-32 max-h-80 reveal-up"
              ></textarea>
            </div>
